<template>
  <div class="col-span-full xl:col-span-6 bg-white shadow-lg rounded-sm border border-slate-200">
    <header class="px-5 py-4 border-b border-slate-100">
      <h2 class="font-semibold text-slate-800">Ingresos/Gastos</h2>
    </header>
    <div class="p-3">
      ...
      <!-- "Today" group -->
      <div>
        <header class="text-xs uppercase text-slate-400 bg-slate-50 rounded-sm font-semibold p-2">Hoy</header>
        <ul class="my-1">
          <!-- Item -->
          <li class="flex px-2">
            ...
            <div class="grow flex items-center border-b border-slate-100 text-sm py-2">
              <div class="grow flex justify-between">
                <div class="self-center"><a class="font-medium text-slate-800 hover:text-slate-900" href="#0">Marcelo</a> devolución</div>
          ...
          <li class="flex px-2">
            ...
            <div class="grow flex items-center border-b border-slate-100 text-sm py-2">
              <div class="grow flex justify-between">
                <div class="self-center"><a class="font-medium text-slate-800 hover:text-slate-900" href="#0">Lexi.com</a> Compra de En Vivo</div>
                <div class="shrink-0 self-start ml-2">
          ...
          <li class="flex px-2">
            ...
            <div class="grow flex items-center border-b border-slate-100 text-sm py-2">
              <div class="grow flex justify-between">
                <div class="self-center"><a class="font-medium text-slate-800 hover:text-slate-900" href="#0">Consulting Express</a> Membresía Pro</div>
                <div class="shrink-0 self-start ml-2">
          ...
          <li class="flex px-2">
            ...
            <div class="grow flex items-center border-b border-slate-100 text-sm py-2">
              <div class="grow flex justify-between">
                <div class="self-center"><a class="font-medium text-slate-800 hover:text-slate-900" href="#0">Lexi.com</a> Desconexión en plena transacción</div>
                <div class="shrink-0 self-start ml-2">
          ...
          <li class="flex px-2">
            ...
            <div class="grow flex items-center text-sm py-2">
              <div class="grow flex justify-between">
                <div class="self-center"><a class="font-medium text-slate-800 hover:text-slate-900" href="#0">Lexi.com</a> Reembolso por corrección</div>
                <div class="shrink-0 self-start ml-2">
                  <span class="font-medium text-slate-800">-$49.88</span>
                </div>
              </div>
