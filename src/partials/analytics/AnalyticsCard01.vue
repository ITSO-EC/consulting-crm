      ...
      <div class="flex flex-wrap">
        ...
        <div class="flex items-center py-2">
          <div class="mr-5">
            ...
            <div class="text-sm text-slate-500">Visitas Únicas</div>
          </div>
        ...
        <div class="flex items-center py-2">
          <div class="mr-5">
            ...
            <div class="text-sm text-slate-500">Páginas Vistas</div>
          </div>
          <div class="hidden md:block w-px h-8 bg-slate-200 mr-5" aria-hidden="true"></div>
        </div>
        <!-- Bounce Rate -->
        <div class="flex items-center py-2">
          <div class="mr-5">
            ...
            <div class="text-sm text-slate-500">Tasa de Rebote</div>
          </div>
          <div class="hidden md:block w-px h-8 bg-slate-200 mr-5" aria-hidden="true"></div>
        </div>
        <!-- Visit Duration-->
