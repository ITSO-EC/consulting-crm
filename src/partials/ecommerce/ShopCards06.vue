<template>
  ...
  <div class="relative col-span-full sm:col-span-6 xl:col-span-3 bg-white shadow-lg rounded-sm border border-slate-200 overflow-hidden">
    ...
    <div class="relative h-full p-5 flex flex-col justify-end">
      <h3 class="text-lg text-white font-semibold mt-16 mb-0.5">Marco Legal Actualizado</h3>
      <a class="text-sm font-medium text-indigo-400 hover:text-indigo-300" href="#0">Ingresar -&gt;</a>
    </div>
  </div>
  ...
  <div class="relative col-span-full sm:col-span-6 xl:col-span-3 bg-white shadow-lg rounded-sm border border-slate-200 overflow-hidden">
    ...
    <!-- Content -->
    <div class="relative h-full p-5 flex flex-col justify-end">
      <h3 class="text-lg text-white font-semibold mt-16 mb-0.5">Marco Legal Específico</h3>
      <a class="text-sm font-medium text-indigo-400 hover:text-indigo-300" href="#0">Ingresar -&gt;</a>
    </div>
  </div>
  ...
  <div class="relative col-span-full sm:col-span-6 xl:col-span-3 bg-white shadow-lg rounded-sm border border-slate-200 overflow-hidden">
    ...
    <!-- Content -->
    <div class="relative h-full p-5 flex flex-col justify-end">
      <h3 class="text-lg text-white font-semibold mt-16 mb-0.5">Marco Legal Diario</h3>
      <a class="text-sm font-medium text-indigo-400 hover:text-indigo-300" href="#0">Ingresar -&gt;</a>
    </div>
  </div>
  ...
  <div class="relative col-span-full sm:col-span-6 xl:col-span-3 bg-white shadow-lg rounded-sm border border-slate-200 overflow-hidden">
    ...
    <!-- Content -->
    <div class="relative h-full p-5 flex flex-col justify-end">
      <h3 class="text-lg text-white font-semibold mt-16 mb-0.5">Noticias</h3>
      <a class="text-sm font-medium text-indigo-400 hover:text-indigo-300" href="#0">Ingresar -&gt;</a>
    </div>
  </div>
</template>
